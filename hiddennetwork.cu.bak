...
HiddenUnit::HiddenUnit(int input_size,int output_size,int batch_size,std::string network_name,cublasHandle_t cublas,float learning_rate,float adagrad_epsilon,float annuation_rate):
	BaseUnit(input_size,output_size,batch_size,network_name,cublas,learning_rate,adagrad_epsilon,annuation_rate)
{
}

HiddenUnit::~HiddenUnit(){}

void HiddenUnit::learningBackPropagation(mtk::MatrixXf &next_error, const mtk::MatrixXf &d2, const mtk::MatrixXf *w2){
...
void HiddenUnit::learningActivation(mtk::MatrixXf &output, const mtk::MatrixXf &input) {
	mtk::MatrixFunction::map<ActReLU>(output,input);
}
void HiddenUnit::testActivation(mtk::MatrixXf &output, const mtk::MatrixXf &input) {
	mtk::MatrixFunction::map<ActReLU>(output,input);
}

void HiddenUnit::learningBackPropagation(mtk::MatrixXf &next_error, const mtk::MatrixXf &d2){
